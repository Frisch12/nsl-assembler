...
public class AddPluginDirInstruction extends AssembleExpression {
    public static final String name = "AddPluginDir";

    private Expression path;

    @SuppressWarnings("Duplicates")
    public AddPluginDirInstruction(int returns) {
    ...
    public void assemble() throws IOException {
        ...
        ScriptParser.writeLine("!addplugindir \"" + this.path.getStringValue() + "\"");
    }
